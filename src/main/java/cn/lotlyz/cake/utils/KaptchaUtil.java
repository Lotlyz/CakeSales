...
public class KaptchaUtil {
    ...
    public static void createKaptchaImg(HttpSession session, HttpServletResponse response) throws IOException {
    ...
    //随机生成一个+—X/的表达式 并返回
    private static String create(HttpSession session){
